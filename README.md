...
See [`SQL_queries.sql`](./SQL_queries.sql](https://github.com/Iyeose/Sales-Performance-Dashboard/blob/main/sample_superstore_SQL.txt)](https://github.com/Iyeose/Sales-Performance-Dashboard/blob/main/sample_superstore_SQL.txt)) for full list of SQL commands.
